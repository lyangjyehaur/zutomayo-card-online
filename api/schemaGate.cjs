...
const REQUIRED_RUNTIME_COLUMNS = Object.freeze({
  ...
  match_analytics_decks: ['source_match_digest', 'seat', 'card_ids', 'deck_hash', 'deck_source', 'deck_validation'],
  match_analytics_events: [
    'source_match_digest',
    'sequence',
    'turn',
...
const REQUIRED_RUNTIME_CONSTRAINTS = Object.freeze([
  {
    ...
    constraintName: 'bjg_match_seats_resume_count_check',
    constraintType: 'c',
    fragments: ['resume_count >= 0'],
  },
  {
  ...
  },
  {
    ...
    constraintType: 'c',
    fragments: ['quick_match', 'custom_room', 'invite', 'traffic_class', 'synthetic'],
  },
  {
    tableName: 'bjg_match_telemetry',
  ...
  { tableName: 'match_analytics', constraintType: 'p', fragments: ['primary key (source_match_digest)'] },
  {
    ...
    constraintType: 'c',
    fragments: ['source_match_digest ~', '^[0-9a-f]{64}$', 'integrity_sha256 ~'],
  },
  {
    tableName: 'match_analytics',
    constraintName: 'match_analytics_counts_check',
    constraintType: 'c',
    fragments: ['deck_count = 2', 'event_count >= 0', 'capture_schema_version = 1'],
  },
  {
    tableName: 'match_analytics_decks',
    constraintType: 'p',
    fragments: ['primary key (source_match_digest, seat)'],
  },
  {
    tableName: 'match_analytics_decks',
    constraintType: 'f',
    fragments: [
      'foreign key (source_match_digest)',
  ...
  {
    tableName: 'match_analytics_decks',
    constraintName: 'match_analytics_decks_content_check',
    constraintType: 'c',
    fragments: ['cardinality(card_ids) = 20', "deck_validation = 'valid'"],
  },
  {
    tableName: 'match_analytics_events',
    constraintType: 'p',
    fragments: ['primary key (source_match_digest, sequence)'],
  },
  {
    tableName: 'match_analytics_events',
    constraintType: 'f',
...
const REQUIRED_RUNTIME_INDEXES = Object.freeze([
  {
    ...
    indexName: 'idx_support_emails_status_received',
    fragments: ['status', 'received_at desc'],
  },
  {
    tableName: 'support_email_replies',
    indexName: 'idx_support_email_replies_thread',
    fragments: ['support_email_id', 'sent_at'],
  },
  {
    tableName: 'bjg_match_telemetry',
    indexName: 'idx_bjg_match_telemetry_classification',
    fragments: ['match_mode', 'traffic_class', 'updated_at'],
  },
  {
    tableName: 'match_analytics',
    indexName: 'idx_match_analytics_completed_at',
    fragments: ['completed_at desc'],
  },
  {
    tableName: 'match_analytics',
    indexName: 'idx_match_analytics_version_analysis',
    fragments: ['rules_version', 'dataset_sha256', 'completed_at'],
  },
  {
    tableName: 'match_analytics_events',
    indexName: 'idx_match_analytics_events_type_step',
    fragments: ['event_type', 'step'],
  },
  {
    tableName: 'knowledge_search_zero_results',
