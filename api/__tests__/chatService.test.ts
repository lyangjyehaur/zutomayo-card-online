    ...
    const pool = poolWithResults([
      {
        rows: [
          ...
          },
          {
            ...
            latest_message_id: 'chat_msg_room_latest',
          },
          {
            ...conversationRow,
          ...
          {
            ...conversationRow,
            id: 'global:online-lobby',
            type: 'global',
            subject_id: 'online-lobby',
            unread_count: '4',
            latest_message_at: '2026-07-10T00:00:07.000Z',
            latest_message_id: 'chat_msg_global_latest',
          },
        ],
      },
    ]);
      ...
      body: {
        conversations: [
          ...
          expect.objectContaining({
            ...
            latestMessageId: 'chat_msg_room_latest',
          }),
          expect.objectContaining({
            id: 'direct:v1:logto%3Au_2:u_4',
            unreadCount: 1,
          ...
          expect.objectContaining({
            id: 'global:online-lobby',
            unreadCount: 4,
            latestMessageAt: '2026-07-10T00:00:07.000Z',
            latestMessageId: 'chat_msg_global_latest',
          }),
        ],
      },
    });
      ...
      },
      {
        rows: [
          ...
          },
          {
            ...
            author_role: 'spectator',
            content: 'pending review evidence',
            source_language: '',
            moderation_status: 'pending_review',
            moderation_reason: 'review_keyword',
            metadata: {},
            created_at: '2026-07-10T00:00:02.000Z',
            edited_at: null,
            deleted_at: null,
    ...
    await expect(listChatEvidenceMessages({ pool, conversationId: 'match:bgio-match-1', limit: 20 })).resolves.toEqual({
      ...
      body: {
        ...
        messages: [
          ...
          expect.objectContaining({ id: 'chat_msg_pending', moderationStatus: 'pending_review' }),
