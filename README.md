...
0.2.4 加入卡牌圖鑑、牌組分享中繼資料與搭配推薦、第四彈 105～107 SE 效果及 Refine 管理後台；同時重做 Chronos／HP／攻擊結算動畫、Online／AI 大廳、公開房間列表、對局聊天與同房再戰，並讓新手教學沿用正式戰場的結算呈現。

### 遊戲與對戰

- 本機雙人與簡單／普通／困難 AI；困難 AI 目前使用不含卡牌效果的本回合 lookahead 模擬，能力邊界與改造方向見 [AI 難度計畫](docs/ai-difficulty-roadmap.md)。
- 425 張卡牌、4 個卡包，270 行效果文字完整解析；包含經獨立複核與稽核發布的第四彈 105～107 SE 卡。
