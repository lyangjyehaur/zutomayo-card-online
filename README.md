...
- Server-validated choice flows cover hand-to-deck-bottom draw, focused card moves, Clock choices, own Abyss-to-deck-bottom payments that lose if unpaid, and the `4th_27` selected-count mill follow-up.
