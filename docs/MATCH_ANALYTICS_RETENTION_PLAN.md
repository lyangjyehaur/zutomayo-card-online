...
只在首次 seat proof 之後再次成功恢復座位時增加 `bjg_match_seats.resume_count`。終局／abandoned projector 才把三組固定兩席計數移入永久層；
...
| MA-05 | P1       | 保存配對來源與連線生命週期摘要               | In progress | MA-01, MA-02        | 首次 proof 不計 resume 的本地修補與 tests 已完成；direct provenance/重連追因及 staging fixtures 待執行                                   |
...
| MA-07 | P1       | 建立資料品質檢查、metrics 與告警             | In progress | MA-03, MA-04        | production identity/integrity reconciliation 通過；空房 cohort/resume 語義已本地修補；direct lifecycle 指標與 staging alert drill 待執行 |
| MA-08 | P1       | 建立核心分析 queries 與最低樣本規則          | In progress | MA-03, MA-05, MA-06 | 未成局空房 cohort query/PG fixture 已本地驗證；production 僅 16 terminal、最高 deck appearance 12，未達 100 門檻                         |
