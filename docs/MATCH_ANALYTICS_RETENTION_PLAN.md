...
| MA-02 | P0       | 建立 additive analytics schema 與權限        | In progress | MA-01               | migration、schema/role gates 與 disposable PG role smoke 已完成；MA-01 review 待完成                                 |
...
| MA-04 | P0       | 將 stale cleanup 改成 archive-before-delete  | In progress | MA-03               | terminal guard、abandoned capture、TTL 分流與 unit tests 已完成；staging concurrency drill 待執行                    |
...
| MA-07 | P1       | 建立資料品質檢查、metrics 與告警             | In progress | MA-03, MA-04        | counters、durable gauges、dashboard 與 alerts 已完成；staging alert drill 待執行                                     |
...
| MA-10 | P0       | Staging 驗證與 production rollout            | Open        | MA-03, MA-04, MA-07 | release identity、controlled match receipt、24h reconciliation                                                       |
