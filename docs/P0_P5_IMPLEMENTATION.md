...
- `npm run verify` 通過：Vitest 154 個 test files、1376 tests、dependency patch、資料來源政策、release/operational config、i18n、coverage 與 production/PWA build；coverage statements 64.59%、branches 57.21%、functions 65.96%、lines 67.85%。
...
- [x] `npm run test:coverage`：statements 64.59%、branches 57.21%、functions 65.96%、lines 67.85%。
