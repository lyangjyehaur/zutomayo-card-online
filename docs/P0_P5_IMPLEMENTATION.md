...
- `npm run verify` 通過：Vitest 155 個 test files、1378 tests、dependency patch、資料來源政策、release/operational config、i18n、coverage 與 production/PWA build；coverage statements 64.61%、branches 57.26%、functions 65.96%、lines 67.88%。
...
- [x] `npm run verify`：2026-07-17 current tree 通過，Vitest 155 test files / 1378 tests / production-PWA build；push 後仍須由 required CI 綁定最終 commit SHA。
- [x] `npm run test:coverage`：statements 64.61%、branches 57.26%、functions 65.96%、lines 67.88%。
