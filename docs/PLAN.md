...
| 14    | Admin CRUD framework          | Evaluated | Prefer incremental Refine adoption for the existing admin UI; defer Directus until a broader CMS/back-office permission model is needed. See [MATURE_SYSTEMS.md](MATURE_SYSTEMS.md).                        |
