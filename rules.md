...
- 尚未完整支援全部 422 張卡。玩家選擇普通效果順序、傷害減免時機、Chronos transition 事件、部分 Area Enchant 離場與基本手牌選擇流程已支援，但選目標/時間位置、追加出牌、replacement/continuous modifier 與更複雜 timing 仍有限制，詳見 [RULE_GAP_AUDIT.md](RULE_GAP_AUDIT.md)。
