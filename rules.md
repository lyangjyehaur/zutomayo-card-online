...
- 尚未完整支援全部 422 張卡。玩家選擇普通效果順序、傷害減免時機、Chronos transition / zone-entry 事件、部分 Area Enchant 離場、基本手牌/移動選牌與 Clock 選擇流程已支援，但追加出牌、deck ordering、replacement/continuous modifier 與更複雜 timing 仍有限制，詳見 [RULE_GAP_AUDIT.md](RULE_GAP_AUDIT.md)。
