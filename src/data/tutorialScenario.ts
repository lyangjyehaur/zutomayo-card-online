 ...
 * 5. 使用 Enchant（1st_98）與 Area Enchant（2nd_86）
 ...
 * 玩家手牌：[1st_2(pc7), 1st_70, 1st_34, 2nd_86, 1st_66]
 *   - 1st_2 powerCost=7，回合 1 充能區空(power=0) < 7 → 攻擊力 0，引導重抽
 *   - 重抽 1st_2 後手牌：[1st_70, 1st_34, 2nd_86, 1st_66, 1st_66]
 ...
 * 玩家出 1st_34（Character, slot A）+ 2nd_86（Area Enchant → setZoneC）
 * AI 出 1st_98（Enchant, slot A）
 * 時鐘推進：3 + 1st_34.clock(1) + 2nd_86.clock(2) + 1st_98.clock(4) = 10（夜）
 * placeRevealedCards：1st_34 替換 1st_70 進 battleZone；1st_70(sendToPower=2)送充能區
 * 玩家 power = 2（充能區 1st_70）
 *   - 1st_34 pc1, power 2≥1 ✓, night atk 70
 *   - 2nd_86「夜なら攻撃力+20」→ 玩家 atk = 70+20 = 90
 * AI power = 0（充能區空，1st_67 未替換）
 *   - 1st_67 pc0, power 0≥0 ✓, night atk 50
 *   - 1st_98「対手角色 pc0/1 なら攻撃力+30」→ 1st_34 pc1 符合 → AI atk = 50+30 = 80
 * 戰鬥：玩家 90 > AI 80 → 玩家贏，AI 受 10 傷害（100→90）
 * 回合結束：1st_98(sendToPower=0)送深淵
 */

/**
 * 玩家牌組（20 張，陣列順序 = 牌庫順序）。
 * 前 5 張為初始手牌：[1st_2, 1st_70, 1st_34, 2nd_86, 1st_66]
...
export const TUTORIAL_DECK0_IDS: string[] = [
  ...
  '1st_34', // 手牌2: T2 battleZone（pc1, night70）
  '2nd_86', // 手牌3: T2 Area Enchant（夜+20攻）
