...
export const en: Record<TranslationKey, string> = {
  ...
  'profile.exported': 'Account data download started',
  'profile.exportStatusQueued': 'Queued',
  'profile.exportStatusProcessing': 'Preparing',
  'profile.exportStatusReady': 'Ready',
  'profile.exportStatusFailed': 'Failed',
  'profile.exportStatusExpired': 'Expired',
  'profile.exportQueuedDescription':
    'Your request is queued. You can leave this page; progress will resume when you return.',
  'profile.exportProcessingDescription': 'We are securely preparing a compressed archive of your account data.',
  'profile.exportReadyDescription': 'Your compressed account archive is ready to download.',
  'profile.exportFailedDescription': 'The archive could not be prepared. You can request a new export.',
  'profile.exportExpiredDescription': 'This archive is no longer available. Request a new export to continue.',
  'profile.exportExpiresAt': 'Available until',
  'profile.exportFileSize': 'File size',
  'profile.exportPreparing': 'Preparing export',
  'profile.exportDownload': 'Download archive',
  'profile.exportRetry': 'Request new export',
  'profile.exportLoadError': 'Could not load your recent export. You can still request a new one.',
  'profile.exportStatusError': 'Could not refresh export progress. We will try again automatically.',
  'profile.exportCreateError': 'Could not request an account export. Try again later.',
  ...
  'chat.matchAccessDenied': 'Match seat verification failed',
  'chat.matchOffline': 'Chat temporarily unavailable',
  ...
  'lobby.homeStart': 'Start a match',
  'lobby.homeEnter': 'Enter online rooms',
  'lobby.homeTutorialCaption': 'Learn cards, Chronos, and turn flow through interactive chapters',
  'lobby.homeChannels': 'Channels',
  'lobby.homeExplore': 'Explore and manage',
  'lobby.homeExploreCaption': 'Read official rules and follow rankings, community, and match history.',
  'lobby.cardWorkspaceKicker': 'CARDS & DECKS',
  'lobby.cardWorkspaceTitle': 'Discover cards, then build',
  'lobby.cardWorkspaceDescription':
    'Review complete card data and synergies, build a deck, or explore decks shared by other players.',
  ...
  'community.loginRequiredTitle': 'Sign in to join the community',
  ...
  'board.revealedHand.title': 'Temporarily revealed hand',
  'board.revealedHand.description': "Review your opponent's current hand. It becomes hidden again after you confirm.",
  'board.revealedHand.temporary': 'Visible for this effect only',
  'board.revealedHand.done': 'Done reviewing',
  'board.revealedHand.empty': 'Your opponent has no cards in hand',
  'board.revealedHand.waiting': 'Opponent is reviewing the hand',
  'board.revealedHand.waitingDescription': 'Effect resolution continues after they finish reviewing.',
  'board.revealedHand.log': "temporarily revealed the opponent's hand",
  'board.revealedHand.deckTitle': 'Revealed deck-top card',
  'board.revealedHand.deckDescription': 'Review the revealed card and its effect check before continuing.',
  'board.revealedHand.guessTitle': 'Card-name guess result',
  'board.revealedHand.ownTitle': 'Cards revealed from your hand',
  'board.revealedHand.ownDescription': 'These cards are temporarily visible to your opponent for this effect.',
  'board.revealedHand.declared': 'Declared',
  'board.revealedHand.hit': 'Match',
  'board.revealedHand.miss': 'No match',
  'board.revealedHand.attackFormula': 'Attack boost',
  'board.choiceDeclareCardName': 'Declare a card name',
  'board.choiceSearchPlaceholder': 'Search by card name, number, or song',
  'board.choiceDeckOrder': 'Deck order',
  'board.choiceDeckTop': 'Deck top',
  'board.choiceMoveUp': 'Move toward deck top',
  'board.choiceMoveDown': 'Move away from deck top',
  'board.choiceHandPosition': 'Hand card',
  'board.choiceNoSearchResults': 'No matching cards',
  'board.choiceDetails': 'View details',
  'board.status.active': 'Active effects',
  'board.status.element': 'Element',
  'board.status.cost': 'Cost',
  'board.status.clock': 'Card clock',
  'board.status.effectsDisabled': 'Effects disabled',
  'board.status.enchantDisabled': 'Enchant effects disabled',
  'board.status.midnight': 'Midnight range',
  'board.status.hand': 'Hand size',
  'board.status.set': 'Set limit',
  'board.status.clockDisabled': 'Clock contribution disabled',
  'board.status.attackTime': 'Attack side',
  'board.status.attackSwap': 'Day/night ATK swapped',
  'board.hp': 'HP',
  ...
  'board.chronosResolution.total': 'Clock total',
  'board.chronosResolution.advance': 'Advance',
  'board.chronosResolution.rewind': 'Rewind',
  'board.chronosResolution.setPosition': 'Set position',
  'board.chronosResolution.spaces': 'spaces',
  'board.choiceChronosPositionHint': 'Choose the target directly on the Chronos dial',
  ...
  'board.notice.battleNoAttack': 'No attack',
  'board.notice.battleNoDamage': 'Damage fully reduced',
  'board.notice.battle': 'Battle result',
  'board.notice.effectFailure': 'Effect did not activate',
  'board.notice.effectFailure.disabled': 'This card effect is disabled.',
  'board.notice.effectFailure.powerCost': 'There is not enough Power to activate this effect.',
  'board.notice.effectFailure.condition': 'The activation condition was not met.',
  'board.me': 'Me',
  ...
  'board.reasonInfiniteLoop': 'Unavoidable infinite loop',
  ...
  'history.draw': 'Draw',
  'history.searchLabel': 'Search match replays',
  'history.searchPlaceholder': 'Search phases, actions, effects, cards, or choices',
  'history.outcomeFilter': 'Result filter',
  'history.filterAll': 'All results',
  'history.noSearchResults': 'No matches meet these filters',
  'history.replayPhases': 'Phase Summary',
  'history.replayTraceComplete': 'Complete decision trace',
  'history.replayLegacy': 'Legacy summary',
  'history.replayDecisions': 'Decision Order',
  'history.replayNoDecisions': 'No decision records are available for this match',
  'history.replayEffects': 'Effect Order',
  'history.replayNoEffects': 'No effect records are available for this match',
  'history.replayRevealedHands': 'Revealed Hands',
  ...
  'deckShare.lobbyTitle': 'Deck Hub',
  'deckShare.lobbyKicker': 'Community Decks',
  'deckShare.lobbyHeading': 'Explore decks shared by players',
  'deckShare.lobbyDescription': 'Browse public decks, inspect every card, and find your next build to try.',
  'deckShare.searchPlaceholder': 'Search decks or authors…',
  'deckShare.clearSearch': 'Clear search',
  'deckShare.resultCount': '{count} decks',
  'deckShare.openDeck': 'View deck',
  'deckShare.shareDeck': 'Share a deck',
  'deckShare.chooseDeckTitle': 'Choose a deck to share',
  'deckShare.chooseDeckDescription': 'Select a deck saved to your account, then choose how it will be shared.',
  'deckShare.chooseDeckLabel': 'Saved deck',
  'deckShare.loadingDecks': 'Loading your decks…',
  'deckShare.noSavedDecksTitle': 'No decks ready to share',
  'deckShare.noSavedDecksBody': 'Create and save a complete deck in the Deck Editor before publishing it here.',
  'deckShare.createDeck': 'Create deck',
  'deckShare.localPreview': 'Local preview',
  'deckShare.localPreviewNotice':
    'The local database has no public shares, so four development-only sample decks are shown.',
  'deckShare.demoName': 'Chronos Flame-Wind Tempo',
  'deckShare.demoNameDarkElectric': 'Shadow-Spark Control',
  'deckShare.demoNameFire': 'Blazing Rush',
  'deckShare.demoNameChaosWind': 'Chaos-Wind Toolbox',
  'deckShare.demoAuthor': 'Local preview',
  'deckShare.elementFilter': 'Element filter',
  'deckShare.allElements': 'All elements',
  'deckShare.sortLabel': 'Sort',
  'deckShare.sortPopular': 'Popular',
  'deckShare.sortNewest': 'Newest',
  'deckShare.sortMostCopied': 'Most copied',
  'deckShare.loading': 'Loading shared decks…',
  'deckShare.loadingMore': 'Loading more…',
  'deckShare.loadMore': 'Load more',
  'deckShare.loadError': 'The deck hub could not be loaded. Please try again.',
  'deckShare.loadMoreError': 'The next page could not be loaded. Existing results are preserved.',
  'deckShare.errorTitle': 'Deck hub unavailable',
  'deckShare.emptyTitle': 'No public decks yet',
  'deckShare.emptyBody': 'Published community decks will appear here.',
  'deckShare.emptyFilteredTitle': 'No matching decks',
  'deckShare.emptyFilteredBody': 'Try clearing the search or changing the element filter.',
  'deckShare.clearFilters': 'Clear filters',
  'deckShare.results': 'Shared deck results',
  'deckShare.unknownAuthor': 'Unknown author',
  'deckShare.characters': '{count} Characters',
  'deckShare.likes': 'Likes',
  'deckShare.copies': 'Copies',
  'deckShare.detailTitle': 'Shared deck',
  'deckShare.loadingDetail': 'Loading deck details…',
  'deckShare.detailNotFoundTitle': 'Shared deck not found',
  'deckShare.detailNotFound': 'It may be unpublished, under review, or the link may be incorrect.',
  'deckShare.public': 'Public share',
  'deckShare.unlisted': 'Link-only share',
  'deckShare.shareLink': 'Share link',
  'deckShare.linkCopied': 'Share link copied',
  'deckShare.linkCopyFailed': 'Could not copy the share link',
  'deckShare.oldRulesTitle': 'Older rules version',
  'deckShare.oldRulesBody': 'This deck was published under rules {version}. Copies are revalidated today.',
  'deckShare.cards': 'Cards',
  'deckShare.publishedAt': 'Published',
  'deckShare.updatedAt': 'Updated',
  'deckShare.timeUnavailable': 'Unavailable',
  'deckShare.inspectCard': 'Inspect card {card}',
  'deckShare.invalidDeckTitle': 'This deck cannot currently be copied',
  'deckShare.invalidDeckUnknownCards': 'The deck contains cards that are no longer in the current card pool: {cards}',
  'deckShare.invalidDeckCopies': 'Card {card} appears {count} times, exceeding the current limit of 2 copies.',
  'deckShare.invalidDeckSize': 'The deck currently contains {count} cards; current rules require exactly 20.',
  'deckShare.copyDeck': 'Copy to my decks',
  'deckShare.like': 'Like',
  'deckShare.deckContents': 'Deck contents',
  'deckShare.manageTitle': 'Manage deck share',
  'deckShare.publishTitle': 'Publish deck',
  'deckShare.snapshotDescription': 'Sharing publishes a snapshot. Later private edits do not change it automatically.',
  'deckShare.loadingOwned': 'Loading publication status…',
  'deckShare.selectedDeck': 'Selected deck',
  'deckShare.hiddenTitle': 'Share hidden',
  'deckShare.hiddenBody': 'This share is under review or hidden by a moderator and cannot be restored by its owner.',
  'deckShare.outdatedTitle': 'Unpublished changes',
  'deckShare.outdatedBody': 'The private deck changed while the public snapshot still contains the previous version.',
  'deckShare.updateSnapshot': 'Update share',
  'deckShare.visibility': 'Visibility',
  'deckShare.visibilityPublic': 'Public in the deck hub',
  'deckShare.visibilityUnlisted': 'Anyone with the link',
  'deckShare.publishing': 'Publishing…',
  'deckShare.publishAction': 'Publish deck',
  'deckShare.published': 'Published',
  'deckShare.unpublished': 'Unpublished',
  'deckShare.saveVisibility': 'Save visibility',
  'deckShare.republish': 'Republish',
  'deckShare.copyLink': 'Copy link',
  'deckShare.viewShare': 'View share',
  'deckShare.unpublishAction': 'Unpublish',
  'deckShare.unpublishConfirm': 'Unpublish this deck? Public and link-only visitors will no longer be able to view it.',
  'deckShare.ownerLoadError': 'Could not load this deck’s sharing status.',
  'deckShare.saveError': 'Could not save sharing settings. Please try again.',
  'deckShare.publishSuccess': 'Deck published',
  'deckShare.updateSuccess': 'Shared snapshot updated',
  'deckShare.settingsSaved': 'Sharing settings saved',
  'deckShare.unpublishSuccess': 'Deck share unpublished',
  'deckShare.saveServerFirst': 'Save this deck to your account first',
  'deckShare.saveChangesFirst': 'Save the current changes first',
  'deckShare.shareAction': 'Share',
  'deckShare.copySuffix': 'Copy',
  'deckShare.copySuccess': 'Copied to your account decks',
  'deckShare.localCopySuccess': 'Copied to your local decks',
  'deckShare.copyError': 'Could not copy this deck',
  'deckShare.copying': 'Copying…',
  'deckShare.loginToLike': 'Sign in to like shared decks',
  'deckShare.likeError': 'Could not update the like',
  'deckShare.unlike': 'Unlike',
  'deckShare.report': 'Report',
  'deckShare.reported': 'Reported',
  'deckShare.reportTitle': 'Report shared deck',
  'deckShare.reportBody': 'Choose the closest reason. A moderator will review the report.',
  'deckShare.reportReason': 'Reason',
  'deckShare.reportReasonName': 'Inappropriate name',
  'deckShare.reportReasonHarassment': 'Impersonation or harassment',
  'deckShare.reportReasonSpam': 'Spam',
  'deckShare.reportReasonOther': 'Other',
  'deckShare.reportNote': 'Additional details (optional)',
  'deckShare.reportNotePlaceholder': 'Up to 300 characters. Do not include private information.',
  'deckShare.reportSubmit': 'Submit report',
  'deckShare.reporting': 'Submitting…',
  'deckShare.reportSuccess': 'Report submitted. Thank you for helping.',
  'deckShare.reportError': 'Could not submit the report',
  'deckShare.loginToReport': 'Sign in to report a shared deck',
  ...
  'officialRules.navigation': 'Official rules navigation',
  'officialRules.qaTitle': 'Rules Q&A',
  'officialRules.errataTitle': 'Official Errata',
  'officialRules.databaseKicker': 'Official Rules Database',
  'officialRules.qaHeading': 'Official Rules Q&A',
  'officialRules.qaDescription':
    'Search questions and rulings published by the official site. Translations here are not official; open the Japanese source for authoritative wording.',
  'officialRules.searchPlaceholder': 'Search questions, answers, or categories',
  'officialRules.clearSearch': 'Clear search',
  'officialRules.filters': 'Filters',
  'officialRules.clearAll': 'Clear all',
  'officialRules.sort': 'Sort',
  'officialRules.sortOfficial': 'Official number',
  'officialRules.sortLatest': 'Latest published',
  'officialRules.categories': 'Categories',
  'officialRules.all': 'All',
  'officialRules.loading': 'Loading official rules',
  'officialRules.loadError': 'Official rules are unavailable right now. Please try again later.',
  'officialRules.empty': 'No matching content',
  'officialRules.emptyDescription': 'Change the search text or clear the active filters.',
  'officialRules.qaResults': 'Q&A results',
  'officialRules.errataResults': 'Official errata list',
  'officialRules.resultCount': '{count} results',
  'officialRules.relatedCardCount': '{count} related cards',
  'officialRules.showMore': 'Show more',
  'officialRules.translationVerified': 'Reviewed translation',
  'officialRules.translationMachine': 'Machine translation',
  'officialRules.translationSource': 'Japanese source',
  'officialRules.verifiedNotice':
    'This translation was reviewed by this site. The official Japanese text remains authoritative.',
  'officialRules.machineNotice':
    'This is an unofficial machine translation and may contain inaccuracies. Check the Japanese source.',
  'officialRules.showJapanese': 'Show Japanese source',
  'officialRules.officialSource': 'Open official source',
  'officialRules.relatedCards': 'Related cards',
  'officialRules.cardFilterActive': 'Filtering by related card:',
  'officialRules.clearFilter': 'Clear filter',
  'officialRules.notFound': 'The requested official rules entry was not found.',
  'officialRules.answer': 'Answer',
  'officialRules.lastSynced': 'Last synced:',
  'officialRules.errataHeading': 'Official Card Errata',
  'officialRules.errataDescription':
    'Review incorrect printed text and the corrected effective wording. Always use the corrected wording during play.',
  'officialRules.errataSearchPlaceholder': 'Search card name, number, pack, or corrected text',
  'officialRules.changeScope': 'Change type',
  'officialRules.allChanges': 'All changes',
  'officialRules.packFilter': 'Pack',
  'officialRules.allPacks': 'All packs',
  'officialRules.correctionComparison': 'Before and after',
  'officialRules.copyCorrected': 'Copy corrected text',
  'officialRules.copied': 'Copied',
  'officialRules.incorrect': 'Before correction',
  'officialRules.corrected': 'Corrected',
  'officialRules.reason': 'Reason for change',
  'officialRules.replacementPolicy': 'Replacement and correction policy',
  'officialRules.usagePolicy': 'Card usage',
  'officialRules.affectsName': 'Name affected',
  'officialRules.affectsEffect': 'Effect affected',
  ...
  'cardCatalog.nav': 'Card Catalog',
  'cardCatalog.navCaption': 'Browse cards and synergy hints',
  'cardCatalog.browseAction': 'Browse catalog',
  'knowledgeSearch.open': 'Open site search',
  'knowledgeSearch.title': 'Site Search',
  'knowledgeSearch.kicker': 'KNOWLEDGE SEARCH',
  'knowledgeSearch.heading': 'Search cards and official rules',
  'knowledgeSearch.placeholder': 'Search card names, effects, Q&A, or rule text',
  'knowledgeSearch.clear': 'Clear search',
  'knowledgeSearch.scopeLabel': 'Search scope',
  'knowledgeSearch.scope.all': 'All',
  'knowledgeSearch.scope.card': 'Cards',
  'knowledgeSearch.scope.qa': 'Q&A',
  'knowledgeSearch.scope.rule': 'Rules',
  'knowledgeSearch.scope.errata': 'Errata',
  'knowledgeSearch.scope.deck': 'Decks',
  'knowledgeSearch.emptyTitle': 'Enter a term to search',
  'knowledgeSearch.emptyBody':
    'Search card names, songs, effects, official Q&A, rule sections, errata, and public decks in every supported language.',
  'knowledgeSearch.loading': 'Searching',
  'knowledgeSearch.suggestions': 'Search suggestions',
  'knowledgeSearch.error': 'Search is temporarily unavailable. Please try again shortly.',
  'knowledgeSearch.noResults': 'No matching content',
  'knowledgeSearch.noResultsBody': 'Adjust the search term or choose a different scope.',
  'knowledgeSearch.results': 'Search results',
  'knowledgeSearch.resultCount': '{count} results',
  'knowledgeSearch.fallback': 'Fallback search',
  'knowledgeSearch.pagination': 'Search result pages',
  'knowledgeSearch.previous': 'Previous',
  'knowledgeSearch.next': 'Next',
  'cardCatalog.title': 'Card Catalog',
  'cardCatalog.subtitle': 'CARD CATALOG',
  'cardCatalog.kicker': 'CARD DATABASE',
  'cardCatalog.heading': 'Explore cards and effect synergies',
  'cardCatalog.description':
    'Browse every published card by pack, element, and type, with complete text and related cards.',
  'cardCatalog.search': 'Search card name, song, effect, or ID',
  'cardCatalog.filters': 'Filters',
  'cardCatalog.clearFilters': 'Clear filters',
  'cardCatalog.allElements': 'All elements',
  'cardCatalog.allTypes': 'All types',
  'cardCatalog.allPacks': 'All packs',
  'cardCatalog.allRarities': 'All rarities',
  'cardCatalog.allOwnership': 'All ownership',
  'cardCatalog.ownedOnly': 'Owned only',
  'cardCatalog.unownedOnly': 'Not owned only',
  'cardCatalog.owned': 'Owned',
  'cardCatalog.markOwned': 'Mark as owned',
  'cardCatalog.markNotOwned': 'Remove owned mark',
  'cardCatalog.localCollectionNotice': 'Ownership is currently saved only on this device.',
  'cardCatalog.signInToSync': 'Sign in to sync across devices',
  'cardCatalog.collectionLoadError': 'Unable to load card ownership. Please try again later.',
  'cardCatalog.collectionSaveError': 'Unable to save card ownership. The previous setting was restored.',
  'cardCatalog.allDistributions': 'All distribution types',
  'cardCatalog.resultCount': '{count} cards match',
  'cardCatalog.pageRange': 'Showing {start}–{end}',
  'cardCatalog.paginationLabel': 'Card catalog pages',
  'cardCatalog.previousPage': 'Previous',
  'cardCatalog.nextPage': 'Next',
  'cardCatalog.goToPage': 'Go to page {page}',
  'cardCatalog.pageStatus': 'Page {page} of {total}',
  'cardCatalog.loading': 'Loading card catalog…',
  'cardCatalog.loadError': 'Unable to load the card catalog. Please try again.',
  'cardCatalog.empty': 'No cards match these filters',
  'cardCatalog.emptyDescription': 'Adjust the search or filters and try again.',
  'cardCatalog.results': 'Card results',
  'cardCatalog.displayOnly': 'Display only',
  'cardCatalog.clock': 'Chronos',
  'cardCatalog.song': 'Song',
  'cardCatalog.attack': 'Night / day attack',
  'cardCatalog.noEffect': 'No confirmed effect text.',
  'cardCatalog.recommendations': 'Synergy suggestions',
  'cardCatalog.recommendationsDescription':
    'Only cards with an explicit effect interaction or an approved synergy are shown here.',
  'cardCatalog.sameSongCards': 'Cards from the same song',
  'cardCatalog.sameSongCardsDescription':
    'Other cards based on the same song. This is for thematic discovery and does not imply an effect synergy.',
  'cardCatalog.loadingRecommendations': 'Analyzing related cards…',
  'cardCatalog.noRecommendations': 'There is not enough data for suggestions yet.',
  'cardCatalog.openDeckBuilder': 'Open in deck builder',
  'cardCatalog.notPlayable': 'Display-only card; cannot enter a deck',
  'cardCatalog.notFound': 'Card not found',
  'cardCatalog.notFoundDescription': 'The card ID may be incorrect, or this card has not been added yet.',
  'cardCatalog.backToCatalog': 'Back to card catalog',
  ...
  'cardCatalog.nextCard': 'Next card',
  'cardCatalog.type.Character': 'Character',
  'cardCatalog.type.Enchant': 'Enchant',
  'cardCatalog.type.AreaEnchant': 'Area Enchant',
  'cardCatalog.distribution.standard': 'Standard',
  'cardCatalog.distribution.bonus': 'Bonus',
  'cardCatalog.distribution.collaboration': 'Collaboration',
  'cardCatalog.distribution.live': 'Live exclusive',
  'cardCatalog.distribution.event': 'Event exclusive',
  'cardCatalog.distribution.regional': 'Regional exclusive',
  'cardCatalog.reason.namedCard': 'Named card reference',
  'cardCatalog.reason.songReference': 'Song reference',
  'cardCatalog.reason.sameSong': 'Same song',
  'cardCatalog.reason.related': 'Related card',
  'cardCatalog.reason.synergyNamed': 'Named card or song combo',
  'cardCatalog.reason.synergyElement': 'Element synergy',
  'cardCatalog.reason.synergyZone': 'Abyss / Power Charger resource synergy',
  'cardCatalog.reason.synergyChronos': 'Chronos / timing synergy',
  'cardCatalog.reason.synergyDamage': 'HP / damage synergy',
  'cardCatalog.reason.synergyHand': 'Hand / draw synergy',
  'cardCatalog.reason.synergyStats': 'Power Cost / card-type synergy',
  'cardCatalog.reason.synergyDeck': 'Deck / SEND TO POWER synergy',
  'cardCatalog.reason.synergyArea': 'Area Enchant card synergy',
  'cardCatalog.reason.synergyTrigger': 'Event-trigger synergy',
};
