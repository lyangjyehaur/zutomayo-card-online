...
export const ja = {
  ...
  'lobby.localBattle': 'ローカル2人対戦',
  'lobby.aiBattle': 'CPU対戦',
  'lobby.createRoom': 'ルーム作成',
  'lobby.joinRoom': 'ルーム参加',
  'lobby.deckEditor': 'デッキエディター',
  ...
  'lobby.customDeckLocked': '先にデッキエディターでカスタムデッキを作成してください',
  'lobby.menu': 'メインメニュー',
  ...
  'deck.dark': 'シャドウデッキ',
  'deck.flame': 'フレイムバーストデッキ',
  'deck.electric': 'エレクトリックデッキ',
  'deck.wind': 'ウィンドデッキ',
  'deck.custom': 'カスタムデッキ',
  'deck.darkDesc': '夜側の高圧展開と安定した交換',
  'deck.flameDesc': 'バーストダメージと積極攻撃',
  ...
  'board.waitingEffectPlayer': '効果選択を待っています',
