...
export const ja: Record<TranslationKey, string> = {
  ...
  'profile.exported': 'アカウントデータのダウンロードを開始しました',
  'profile.exportStatusQueued': '待機中',
  'profile.exportStatusProcessing': '準備中',
  'profile.exportStatusReady': 'ダウンロード可能',
  'profile.exportStatusFailed': '失敗',
  'profile.exportStatusExpired': '期限切れ',
  'profile.exportQueuedDescription':
    'エクスポートを受け付けました。このページを離れても、戻ったときに進行状況を確認できます。',
  'profile.exportProcessingDescription': 'アカウントデータを安全に収集し、圧縮ファイルを作成しています。',
  'profile.exportReadyDescription': 'アカウントデータの圧縮ファイルをダウンロードできます。',
  'profile.exportFailedDescription': 'エクスポートを完了できませんでした。新しくリクエストできます。',
  'profile.exportExpiredDescription': 'このファイルは利用できなくなりました。もう一度エクスポートしてください。',
  'profile.exportExpiresAt': 'ダウンロード期限',
  'profile.exportFileSize': 'ファイルサイズ',
  'profile.exportPreparing': 'エクスポートを準備中',
  'profile.exportDownload': '圧縮ファイルをダウンロード',
  'profile.exportRetry': 'もう一度エクスポート',
  'profile.exportLoadError': '最近のエクスポートを読み込めませんでした。新しくリクエストすることはできます。',
  'profile.exportStatusError': '進行状況を更新できませんでした。自動的に再試行します。',
  'profile.exportCreateError': 'エクスポートをリクエストできませんでした。後でもう一度お試しください。',
  ...
  'chat.matchAccessDenied': '対戦席を確認できません',
  'chat.matchOffline': 'チャットを一時的に利用できません',
  ...
  'lobby.homeExploreCaption': '公式ルール、ランキング、コミュニティ、対戦履歴へ。',
  'lobby.cardWorkspaceKicker': 'カード＆デッキ',
  'lobby.cardWorkspaceTitle': 'カードを知り、デッキを組む',
  'lobby.cardWorkspaceDescription':
    '図鑑でカード情報とシナジーを確認し、デッキを構築したり、ほかのプレイヤーのデッキを探したりできます。',
  ...
  'board.revealedHand.title': '一時公開された相手の手札',
  'board.revealedHand.description': '相手の現在の手札を確認できます。確認後、この情報は再び非公開になります。',
  'board.revealedHand.temporary': 'この効果の間のみ確認可能',
  'board.revealedHand.done': '確認完了',
  'board.revealedHand.empty': '相手の手札はありません',
  'board.revealedHand.waiting': '相手が手札を確認中',
  'board.revealedHand.waitingDescription': '確認が終わると効果処理を続行します。',
  'board.revealedHand.log': '相手の手札を一時公開しました',
  'board.revealedHand.deckTitle': '公開されたデッキトップ',
  'board.revealedHand.deckDescription': '公開カードと効果判定を確認してから解決を続けます。',
  'board.revealedHand.guessTitle': 'カード名宣言の結果',
  'board.revealedHand.ownTitle': '自分の手札から公開したカード',
  'board.revealedHand.ownDescription': 'これらのカードはこの効果中、一時的に相手へ公開されます。',
  'board.revealedHand.declared': '宣言',
  'board.revealedHand.hit': '一致',
  'board.revealedHand.miss': '不一致',
  'board.revealedHand.attackFormula': '攻撃力上昇',
  'board.choiceDeclareCardName': 'カード名を宣言',
  'board.choiceSearchPlaceholder': 'カード名・番号・楽曲で検索',
  'board.choiceDeckOrder': 'デッキの順番',
  'board.choiceDeckTop': 'デッキトップ',
  'board.choiceMoveUp': 'デッキトップへ移動',
  'board.choiceMoveDown': 'デッキ下側へ移動',
  'board.choiceHandPosition': '手札',
  'board.choiceNoSearchResults': '該当するカードがありません',
  'board.choiceDetails': '詳細を見る',
  'board.status.active': '有効な効果',
  'board.status.element': '属性',
  'board.status.cost': 'コスト',
  'board.status.clock': 'カード時計',
  'board.status.effectsDisabled': '効果無効',
  'board.status.enchantDisabled': 'エンチャント効果無効',
  'board.status.midnight': '深夜範囲',
  'board.status.hand': '手札上限',
  'board.status.set': 'セット上限',
  'board.status.clockDisabled': '時計加算なし',
  'board.status.attackTime': '攻撃時間帯',
  'board.status.attackSwap': '昼夜攻撃入替',
  'board.hp': 'HP',
  'board.energy': 'パワーコスト',
  'board.deck': 'デッキ',
  'board.abyss': 'アビス',
  ...
  'board.chronosResolution.rewind': '巻き戻し',
  'board.chronosResolution.setPosition': '位置指定',
  'board.chronosResolution.spaces': 'マス',
  'board.choiceChronosPositionHint': 'クロノス盤面で目標位置を選んでください',
  ...
  'board.notice.battleNoAttack': '攻撃不成立',
  'board.notice.battleNoDamage': 'ダメージ完全軽減',
  'board.notice.battle': '戦闘結果',
  'board.notice.effectFailure': '効果は発動しませんでした',
  'board.notice.effectFailure.disabled': 'このカードの効果は無効です。',
  'board.notice.effectFailure.powerCost': 'Power が不足しているため効果を発動できません。',
  'board.notice.effectFailure.condition': '発動条件を満たしていません。',
  'board.me': '自分',
  'board.opponent': '相手',
  ...
  'board.reasonInfiniteLoop': '停止できない永久循環',
  ...
  'history.draw': '引き分け',
  'history.searchLabel': '対戦リプレイを検索',
  'history.searchPlaceholder': 'フェーズ、操作、効果、カード、選択を検索',
  'history.outcomeFilter': '結果フィルター',
  'history.filterAll': 'すべての結果',
  'history.noSearchResults': '条件に一致する対戦履歴はありません',
  'history.replayPhases': 'フェーズ概要',
  'history.replayTraceComplete': '完全な決定記録',
  'history.replayLegacy': '旧形式の概要',
  'history.replayDecisions': '決定順',
  'history.replayNoDecisions': 'この対戦には決定記録がありません',
  'history.replayEffects': '効果順',
  'history.replayNoEffects': 'この対戦には効果記録がありません',
  'history.replayRevealedHands': '公開された手札',
  ...
  'cardCatalog.nav': 'カード図鑑',
  'cardCatalog.navCaption': 'カード情報と連動候補を見る',
  'cardCatalog.browseAction': '図鑑を見る',
  'knowledgeSearch.open': 'サイト内検索を開く',
  'knowledgeSearch.title': 'サイト内検索',
  'knowledgeSearch.kicker': 'KNOWLEDGE SEARCH',
  'knowledgeSearch.heading': 'カードと公式ルールを検索',
  'knowledgeSearch.placeholder': 'カード名、効果、Q&A、ルール本文を検索',
  'knowledgeSearch.clear': '検索をクリア',
  'knowledgeSearch.scopeLabel': '検索範囲',
  'knowledgeSearch.scope.all': 'すべて',
  'knowledgeSearch.scope.card': 'カード',
  'knowledgeSearch.scope.qa': 'Q&A',
  'knowledgeSearch.scope.rule': 'ルール',
  'knowledgeSearch.scope.errata': 'エラッタ',
  'knowledgeSearch.scope.deck': 'デッキ',
  'knowledgeSearch.emptyTitle': 'キーワードを入力してください',
  'knowledgeSearch.emptyBody': '各言語のカード名、楽曲名、効果、公式Q&A、ルール、エラッタ、公開デッキを検索できます。',
  'knowledgeSearch.loading': '検索中',
  'knowledgeSearch.suggestions': '検索候補',
  'knowledgeSearch.error': '検索サービスを一時的に利用できません。しばらくしてからもう一度お試しください。',
  'knowledgeSearch.noResults': '一致する情報がありません',
  'knowledgeSearch.noResultsBody': 'キーワードまたは検索範囲を変更してください。',
  'knowledgeSearch.results': '検索結果',
  'knowledgeSearch.resultCount': '{count}件の結果',
  'knowledgeSearch.fallback': 'フォールバック検索',
  'knowledgeSearch.pagination': '検索結果ページ',
  'knowledgeSearch.previous': '前へ',
  'knowledgeSearch.next': '次へ',
  'cardCatalog.title': 'カード図鑑',
  'cardCatalog.subtitle': 'CARD CATALOG',
  'cardCatalog.kicker': 'カードデータベース',
  'cardCatalog.heading': 'カードと効果の連動を探す',
  'cardCatalog.description': '公開済みカードをパック、属性、種類で検索し、テキストと関連カードを確認できます。',
  'cardCatalog.search': 'カード名、楽曲、効果、IDを検索',
  'cardCatalog.filters': '絞り込み',
  'cardCatalog.clearFilters': '絞り込みを解除',
  'cardCatalog.allElements': 'すべての属性',
  'cardCatalog.allTypes': 'すべての種類',
  'cardCatalog.allPacks': 'すべてのパック',
  'cardCatalog.allRarities': 'すべてのレアリティ',
  'cardCatalog.allOwnership': 'すべての所持状況',
  'cardCatalog.ownedOnly': '所持カードのみ',
  'cardCatalog.unownedOnly': '未所持カードのみ',
  'cardCatalog.owned': '所持済み',
  'cardCatalog.markOwned': '所持カードに登録',
  'cardCatalog.markNotOwned': '所持登録を解除',
  'cardCatalog.localCollectionNotice': '所持状況は現在この端末にのみ保存されています。',
  'cardCatalog.signInToSync': 'ログインして端末間で同期',
  'cardCatalog.collectionLoadError': 'カードの所持状況を読み込めませんでした。時間をおいて再度お試しください。',
  'cardCatalog.collectionSaveError': 'カードの所持状況を保存できなかったため、元の設定に戻しました。',
  'cardCatalog.allDistributions': 'すべての配布区分',
  'cardCatalog.resultCount': '{count}枚が該当',
  'cardCatalog.pageRange': '{start}〜{end}件を表示',
  'cardCatalog.paginationLabel': 'カード図鑑のページ移動',
  'cardCatalog.previousPage': '前へ',
  'cardCatalog.nextPage': '次へ',
  'cardCatalog.goToPage': '{page}ページへ',
  'cardCatalog.pageStatus': '{page} / {total}ページ',
  'cardCatalog.loading': 'カード図鑑を読み込み中…',
  'cardCatalog.loadError': 'カード図鑑を読み込めませんでした。',
  'cardCatalog.empty': '条件に一致するカードがありません',
  'cardCatalog.emptyDescription': '検索語や絞り込み条件を変更してください。',
  'cardCatalog.results': 'カード一覧',
  'cardCatalog.displayOnly': '展示用',
  'cardCatalog.clock': '時計',
  'cardCatalog.song': '楽曲',
  'cardCatalog.attack': '夜／昼攻撃力',
  'cardCatalog.noEffect': '確認済みの効果テキストはありません。',
  'cardCatalog.recommendations': '連動候補',
  'cardCatalog.recommendationsDescription': '効果に明確な相互作用があるカード、または承認済みの連動だけを表示します。',
  'cardCatalog.sameSongCards': '同じ楽曲のカード',
  'cardCatalog.sameSongCardsDescription':
    '同じ楽曲をモチーフにしたカードです。テーマ探索用であり、効果の連動を示すものではありません。',
  'cardCatalog.loadingRecommendations': '連動候補を分析中…',
  'cardCatalog.noRecommendations': '候補を生成する十分なデータがありません。',
  'cardCatalog.openDeckBuilder': 'デッキ編集で見る',
  'cardCatalog.notPlayable': '展示用カードのためデッキに入れられません',
  'cardCatalog.notFound': 'カードが見つかりません',
  'cardCatalog.notFoundDescription': 'カード番号が正しくないか、まだ図鑑に収録されていません。',
  'cardCatalog.backToCatalog': 'カード図鑑に戻る',
  ...
  'cardCatalog.nextCard': '次のカード',
  'cardCatalog.type.Character': 'キャラクター',
  'cardCatalog.type.Enchant': 'エンチャント',
  'cardCatalog.type.AreaEnchant': 'エリアエンチャント',
  'cardCatalog.distribution.standard': '通常収録',
  'cardCatalog.distribution.bonus': '特典',
  'cardCatalog.distribution.collaboration': 'コラボ',
  'cardCatalog.distribution.live': 'ライブ限定',
  'cardCatalog.distribution.event': 'イベント限定',
  'cardCatalog.distribution.regional': '地域限定',
  'cardCatalog.reason.namedCard': 'カード名を参照',
  'cardCatalog.reason.songReference': '楽曲を参照',
  'cardCatalog.reason.sameSong': '同じ楽曲',
  'cardCatalog.reason.related': '関連カード',
  'cardCatalog.reason.synergyNamed': '指定カード／楽曲コンボ',
  'cardCatalog.reason.synergyElement': '属性シナジー',
  'cardCatalog.reason.synergyZone': 'アビス／パワーチャージャーシナジー',
  'cardCatalog.reason.synergyChronos': 'クロノス／時間シナジー',
  'cardCatalog.reason.synergyDamage': 'HP／ダメージシナジー',
  'cardCatalog.reason.synergyHand': '手札／ドローシナジー',
  'cardCatalog.reason.synergyStats': 'パワーコスト／カード種類シナジー',
  'cardCatalog.reason.synergyDeck': 'デッキ／SEND TO POWER シナジー',
  'cardCatalog.reason.synergyArea': 'エリアエンチャントカードシナジー',
  'cardCatalog.reason.synergyTrigger': 'イベント誘発シナジー',
