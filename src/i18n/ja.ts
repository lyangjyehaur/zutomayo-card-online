...
export const ja: Record<TranslationKey, string> = {
  ...
  'board.hpChange.winnerEffectiveAttack': '勝者実攻撃力',
  'board.hpChange.loserRawAttack': '敗者元攻撃力',
  'board.hpChange.loserEffectiveAttack': '敗者実攻撃力',
  'board.hpChange.p0RawAttack': 'プレイヤー1元攻撃力',
  'board.hpChange.p0EffectiveAttack': 'プレイヤー1実攻撃力',
  'board.hpChange.p1RawAttack': 'プレイヤー2元攻撃力',
  'board.hpChange.p1EffectiveAttack': 'プレイヤー2実攻撃力',
