...
export function AuthSection({ onAuthChanged }: { onAuthChanged: () => void | Promise<void> }) {
  ...
  if (user) {
    ...
    return (
      <>
        <section
          className="rounded-sm bg-gradient-to-br from-lacquer via-lacquer to-lacquer-deep p-3 ring-1 ring-bone/10 shadow-[0_8px_32px_-8px] shadow-black/40 md:p-5"
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                <p className="font-display text-base italic leading-none text-bone">
