...
// Load effect translations (generated by scripts/translate-effects.ts)
import effectI18nData from '../../data/card-effects-i18n.json';
const effectI18n: Record<string, Record<string, string>> = effectI18nData as unknown as Record<string, Record<string, string>>;

function getTranslatedEffect(cardId: string, locale: string): string | null {
