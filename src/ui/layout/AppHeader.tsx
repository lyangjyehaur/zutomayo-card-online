    ...
    >
      <div className="pointer-events-auto flex min-w-0 items-center gap-2 rounded-md border border-border-soft bg-surface-base/80 px-3 py-2 backdrop-blur-md">
        {backTo ? (
          <button
            type="button"
            className="-my-1 -ml-1 flex size-touch shrink-0 items-center justify-center rounded-sm text-content-muted transition hover:text-content-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[--focus-ring-color]"
            aria-label="back"
